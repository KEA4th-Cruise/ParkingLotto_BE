...
//        parkingSpaces.add(ParkingSpace.builder().id(1L).draw(draw).slots(10).remainSlots(10).build());
//        parkingSpaces.add(ParkingSpace.builder().id(2L).draw(draw).slots(10).remainSlots(10).build());
...
//        verify(memberDetailRepository, atLeastOnce()).resetRecentLossCount(anyLong());
