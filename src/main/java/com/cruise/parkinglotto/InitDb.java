...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            em.persist(draw);
            Member member = createMember("최준범", "cjb", "111", "developer", "example1@example.com", AccountType.USER, EnrollmentStatus.ENROLLED, "1234", "Seoul", WorkType.TYPE1, "hello", 50, 30, 30.00, 0);
            em.persist(member);
            Applicant applicant = createApplicant(50.0, WinningStatus.WINNER, 1L, 0, 100, "A", 150.0, 1L, 2L, 30.00, WorkType.TYPE1, 50, 30, 0, member, draw);
        ...
        public void dbInit2() {
            ...
            Draw draw = createDraw( DrawType.GENERAL,"2024년도 1회차 주차추첨", drawStartAt,  drawStartAt,  drawStartAt,  drawStartAt, "100", "추첨",  "mapImageUrl",  DrawStatus.OPEN,  100,  "2024",  "1",null);
            em.persist(draw);
            Member member = createMember("준범최", "cjbbb", "112", "marketer", "example2@example.com", AccountType.USER, EnrollmentStatus.ENROLLED, "1236", "Busan", WorkType.TYPE2, "nice", 200, 160, 300.00, 0);
            em.persist(member);
            Applicant applicant = createApplicant(50.0, WinningStatus.WINNER, 2L, 0, 100, "B", 150.0, 1L, 2L, 300.00, WorkType.TYPE2, 200, 160, 0, member, draw);
            em.persist(applicant);
        ...
        private Member createMember(String nameKo, String accountId, String employeeNo, String deptPathName, String email, AccountType accountType, EnrollmentStatus enrollmentStatus, String carNum, String address, WorkType workType, String nickName, Integer trafficCommuteTime, Integer carCommuteTime, Double distance, Integer recentLossCount) {
