...
public enum SuccessStatus implements BaseCode {
    ...
    DRAW_DELETE_SUCCESS(HttpStatus.OK, "DRAW2015", "추첨 삭제를 성공했습니다"),
    ...
    APPLICANT_APPLY_LIST_FOUND(HttpStatus.OK, "APPLICANT2005", "사용자가 신청한 추첨 목록 조회를 성공했습니다."),
    ...
    APPLICANT_CURRENT_APPLY_INFO_FOUND(HttpStatus.OK, "APPLICANT2009", "해당 사용자의 회차 추첨 정보 조회에 성공했습니다"),
